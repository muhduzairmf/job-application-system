                        ...
                        <div class="p-4" x-show="openUpdateForm" x-transition.duration.200ms>
                            ...
                            <div class="ms-form-group">
                                ...
                                <select name="status_recruitment" id="status_recruitment" required>
                                    <option value="5" <?php echo ($job['recruitment_status_id'] == "5") ? "selected" : ""; ?>>Save recruitment notice later.</option>
                                    <option value="1" <?php echo ($job['recruitment_status_id'] == "1") ? "selected" : ""; ?>>Submit to HR to proceed approval from HQ</option>
                                </select>
                            </div>
                            <br>
