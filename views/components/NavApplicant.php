    ...
    <div class="ms-menu">
        ...
        <nav class="ms-menu-link">
            ...
            <label for="ms-menu-toggle" class="ms-menu-icon"
                ><p>&#9776;</p></label>
            <ul>
                <li><a href="./applicant.php?tab=home&section=main">Home</a></li>
                <li><a href="./applicant.php?tab=job&section=main">Job</a></li>
                <li><a href="./applicant.php?tab=message&section=main">Message</a></li>
                <li><a href="./applicant.php?tab=profile&section=user-detail">Profile</a></li>
                <li>
                    <div class="ms-dropdown">
                        <button class="ms-btn">
                            <i class="bi bi-person-circle"></i>&nbsp;&nbsp;Applicant
                        </button>
